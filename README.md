...
**Feb 25, 2025** - Changed [bee data](input/bees) target from bees-targets.csv to bees-population-usda.csv. This new target uses the top 20% of counties with the highest bee population density.
...
[parameters-blinks.yaml](https://raw.githubusercontent.com/ModelEarth/RealityStream/main/parameters/parameters-blinks.yaml) - Uses only features dataset (which contains the target column). Uses bee populatin growth.
